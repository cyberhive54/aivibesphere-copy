  ...
  useEffect(() => {
    ...
    const loadJustLaunchedTools = async () => {
      try {
        ...
        const result = await toolsService.getJustLaunchedTools(6);
    ...
    <section className="py-16 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <Link
            to="/just-launched"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-medium rounded-xl hover:shadow-xl hover:scale-105 smooth-transition group"
          >
